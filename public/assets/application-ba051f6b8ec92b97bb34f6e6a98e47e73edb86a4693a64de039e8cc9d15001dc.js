(() => {
            ...
            filter: {
              ...
              CHILD: function(type, what, _argument, first, last) {
                ...
                return first === 1 && last === 0 ? (
                  ...
                  var cache2, outerCache, node, nodeIndex4, start3, dir2 = simple !== forward ? "nextSibling" : "previousSibling", parent = elem.parentNode, name = ofType && elem.nodeName.toLowerCase(), useCache = !xml && !ofType, diff = false;
                  if (parent) {
                    if (simple) {
                      while (dir2) {
                        node = elem;
                    ...
                    if (forward && useCache) {
                      ...
                      nodeIndex4 = cache2[0] === dirruns && cache2[1];
                      diff = nodeIndex4 && cache2[2];
                      node = nodeIndex4 && parent.childNodes[nodeIndex4];
                      while (node = ++nodeIndex4 && node && node[dir2] || // Fallback to seeking `elem` from the start
                      (diff = nodeIndex4 = 0) || start3.pop()) {
                        if (node.nodeType === 1 && ++diff && node === elem) {
                          outerCache[type] = [dirruns, nodeIndex4, diff];
                          break;
                        }
                      }
                    } else {
                      ...
                      if (diff === false) {
                        while (node = ++nodeIndex4 && node && node[dir2] || (diff = nodeIndex4 = 0) || start3.pop()) {
  ...
  var defineJQueryPlugin = (plugin15) => {
    onDOMContentLoaded(() => {
      ...
      if ($2) {
        ...
        $2.fn[name] = plugin15.jQueryInterface;
        $2.fn[name].Constructor = plugin15;
  ...
  // app/javascript/custom/recipe_form.js
  document.addEventListener("turbo:load", function() {
    ...
    document.getElementById("add-ingredient").addEventListener("click", function(e) {
      ...
      new tom_select_complete_default(newSelect, {
        create: false
        // Disable creation of new options
      });
    });
    recipeForm.addEventListener("click", function(e) {
      if (e.target.classList.contains("remove-ingredient")) {
        ...
        if (ingredientGroup) {
          ...
          ingredientGroup.style.opacity = "0.5";
          ingredientGroup.style.pointerEvents = "none";
  ...
  // app/javascript/custom/brew_form.js
  document.addEventListener("turbo:load", function() {
    ...
    if (recipeInTankElement) {
      new tom_select_complete_default(recipeInTankElement, {
    ...
    if (vesselElement) {
      new tom_select_complete_default(vesselElement, {
  ...
  // app/javascript/custom/brew_calculations.js
  ...
  // app/javascript/custom/addition_log_form.js
  document.addEventListener("turbo:load", function() {
    ...
    if (hopAddition1Element) {
      new tom_select_complete_default(hopAddition1Element, {
    ...
    if (hopAddition2Element) {
      new tom_select_complete_default(hopAddition2Element, {
  ...
  // app/javascript/custom/company_form.js
  document.addEventListener("turbo:load", function() {
    new tom_select_complete_default("#company_partner_ids", {
      plugins: ["remove_button"],
      // Allows users to remove selected items
      maxItems: null,
      // Allows unlimited selections
      create: false,
      // Disables creating new entries
      persist: false,
      hideSelected: true
    });
  });
  ...
  function initializeModals() {
    console.log("\u{1F504} Initializing Bootstrap modals...");
  ...
  function initializeTooltips() {
    console.log("\u{1F6E0} Initializing tooltips...");
  ...
  document.addEventListener("turbo:load", () => {
    console.log("\u{1F525} Turbo page load detected, initializing scripts...");
    initializeModals();
    initializeTooltips();
  });
})();
...
bootstrap/dist/js/bootstrap.esm.js:
  (*!
    ...
    *)
*/
//# sourceMappingURL=/assets/application.js-24bb7b1d0846d57d60a09eb6a2080713164da325c63fdea9d9f2813d12b17443.map
//!
;
